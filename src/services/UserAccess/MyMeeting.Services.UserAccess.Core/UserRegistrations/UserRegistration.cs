...
using MyMeeting.Services.UserAccess.Core.UserRegistrations.Rules;
...
public class UserRegistration : Aggregate<UserRegistrationId>
{
        ...
        string confirmLink)
    {
        ...
        this.AddDomainEvents(new NewUserRegisteredDomainEvent(
            this.Id,
            _login,
            _email,
            _firstName,
    ...
    public void Confirm()
    {
        ...
        //this.AddDomainEvents(new UserRegistrationConfirmedDomainEvent(this.Id));
    }
